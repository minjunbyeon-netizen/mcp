...
def blog_dna_preview():
    ...
    if dna_analysis:
        ...
        font_map = {
            ...
            "궁서": "'NanumBarunGothic', '나눔바른고딕', sans-serif",
            "궁서체": "'NanumBarunGothic', '나눔바른고딕', sans-serif",
        }
        css_font = font_map.get(raw_font, font_map.get(raw_font.split()[0], "'NanumBarunGothic', '나눔바른고딕', sans-serif"))
...
★ 인라인 서식 마커 — DNA c21 패턴 기반, 해당하는 경우만 사용:
  ...
  [폰트 변환] ★ 기본 폰트: 나눔바른고딕 또는 나눔스퀘어 우선 사용. 궁서/필기체 계열 폰트 사용 금지.
  - [폰트:나눔바른고딕]텍스트[/폰트:나눔바른고딕] → NanumBarunGothic (권장 기본)
  - [폰트:나눔스퀘어]텍스트[/폰트:나눔스퀘어]     → NanumSquare (강조 헤딩용)
...
- 이미지 삽입 위치는 [이미지] 마커 하나를 단독 줄에 삽입 (예: 단락 사이 빈 줄 위치에 [이미지]). 이미지가 여러 장이면 [이미지:1] [이미지:2] 처럼 번호 사용. 이미지가 없으면 [이미지] 마커 사용 금지
...
{{
  "versions": [
    ...
    _font_map = {
        ...
        "nanumbrush":           "'NanumBrushScript', '나눔손글씨 붓', cursive",
        "nanumpen":             "'NanumPen', '나눔손글씨 펜', cursive",
        ...
        "malgunbold":           "'Malgun Gothic Bold', '맑은 고딕', sans-serif",
        ...
        "나눔스퀘어라운드":     "'NanumSquareRound', 'NanumSquare', sans-serif",
        "나눔바른히피":         "'nanumbareunhipi', 'NanumGothic', sans-serif",
        "나눔바른고딕":         "'NanumBarunGothic', 'NanumGothic', sans-serif",
        "나눔다시시작해":       "'nanumdasisijaghae', cursive",
        "나눔손글씨붓":         "'NanumBrushScript', cursive",
        "나눔손글씨펜":         "'NanumPen', cursive",
